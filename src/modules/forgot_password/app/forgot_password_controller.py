...
from src.shared.helpers.errors.usecase_errors import NoItemsFound, UserExpiredError, UserNeedsConfirmationError

class ForgotPasswordController:
    def __init__(self, usecase: ForgotPasswordUseCase):
    ...
    def __call__(self, request: IRequest) -> IResponse:
        try: 
            ...
            result = self.ForgotPasswordUseCase(
                email=email
            )

            viewmodel = {
                'message': 'Código de recuperação de senha enviado para o email com sucesso!'
            }
        ...
        except UserNeedsConfirmationError as err:
