class UserApiGatewayDTO:
    ...
    def __init__(self, name: str, email: str, user_id: str, role: str = None):
        self.name = name
        self.email = email
    ...
    def __eq__(self, other):
        return self.name == other.name and self.email == other.email and self.user_id == other.user_id and self.role == other.role